...
class OrderDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_detail" do
    assert_difference("OrderDetail.count") do
      post order_details_url, params: { order_detail: { amount: @order_detail.amount, belongs_to: @order_detail.belongs_to, item: @order_detail.item, order_id: @order_detail.order_id } }
    end
  ...
  test "should update order_detail" do
    patch order_detail_url(@order_detail), params: { order_detail: { amount: @order_detail.amount, belongs_to: @order_detail.belongs_to, item: @order_detail.item, order_id: @order_detail.order_id } }
